...
import { Briefcase, Banknote, GraduationCap, Globe, CalendarDays } from "lucide-react";
import { JobDetailsType } from "@/features/employers/jobQueries";
...
const JobOverview = ({ job }: JobSidebarProps) => {
    const salaryDisplay =
