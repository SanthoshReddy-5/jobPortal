        ...
        <div className="w-64 bg-card border-r border-border fixed bottom-0 top-0">
            ...
            <div className="absolute bottom-6 left-3 right-3">
                <button
                    ...
                    className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent rounded-lg transition-colors w-full hover:cursor-pointer">
