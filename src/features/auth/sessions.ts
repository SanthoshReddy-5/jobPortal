...
const createUserSession=async({token,userId,userAgent,ip,tx=db}:CreateUserSessionData)=>{
...
export const createSessionAndCookies=async (userId:number, tx:DbClient=db)=>{
